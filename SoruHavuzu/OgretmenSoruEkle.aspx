<%@ Page Title="" Language="C#" MasterPageFile="~/OgretmenPage.Master" AutoEventWireup="true" CodeBehind="OgretmenSoruEkle.aspx.cs" Inherits="SoruHavuzu.OgretmenSoruEkle" %>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="YeniSoruEkle.aspx">Yeni Soru
                        </a>
                    </li>
                </ul>
                ...
                <div class="form-horizontal form-row-seperated">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>Yeni Soru Kaydı
                            </div>
                            <div class="actions btn-set">

                                <asp:Button ID="btnKaydet" runat="server" Text="Kaydet" class="btn green" OnClick="btnKaydet_Click" />
                        ...
                        <div class="portlet-body">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_general" data-toggle="tab">Yeni Soru Oluştur
                                        </a>
                                    </li>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:DropDownList ID="ddlDersAdi" AppendDataBoundItems="true" runat="server" class="form-control" OnDataBound="ddlDersAdi_DataBound" AutoPostBack="True" OnSelectedIndexChanged="ddlDersAdi_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:DropDownList ID="ddlKonuAdi" AppendDataBoundItems="true" runat="server" class="form-control" OnDataBound="ddlKonuAdi_DataBound" AutoPostBack="True">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:DropDownList ID="ddlZorlukDerecesi" runat="server" class="form-control" AutoPostBack="True">
                                                        <asp:ListItem Text="Seçiniz" Value="0" />
                                                        <asp:ListItem Value="1">Kolay</asp:ListItem>
                                                        <asp:ListItem Value="2">Orta</asp:ListItem>
                                                        <asp:ListItem Value="3">Zor</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvSoruMetni" runat="server" Text="*" ErrorMessage="Soru Metnini Giriniz" ControlToValidate="txtSoru" ForeColor="Red"></asp:RequiredFieldValidator>

                                                </label>
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtSoru" runat="server" placeholder="Soru Metnini Giriniz" class="form-control" TextMode="MultiLine">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
                                                    A Şıkkı :
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Text="*" ErrorMessage="A Şıkkını Giriniz" ControlToValidate="txtA" ForeColor="Red"></asp:RequiredFieldValidator>

                                                </label>
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtA" runat="server" placeholder="A Şıkkını Giriniz" class="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
                                                    B Şıkkı :
												<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Text="*" ErrorMessage="B Şıkkını Giriniz" ControlToValidate="txtB" ForeColor="Red"></asp:RequiredFieldValidator>

                                                </label>
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtB" runat="server" placeholder="B Şıkkını Giriniz" class="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
                                                    C Şıkkı :
													<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Text="*" ErrorMessage="C Şıkkını Giriniz" ControlToValidate="txtC" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </label>
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtC" runat="server" placeholder="C Şıkkını Giriniz" class="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
                                                    D Şıkkı :
													<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Text="*" ErrorMessage="D Şıkkını Giriniz" ControlToValidate="txtD" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </label>
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtD" runat="server" placeholder="D Şıkkını Giriniz" class="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
                                                    E Şıkkı :
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Text="*" ErrorMessage="E Şıkkını Giriniz" ControlToValidate="txtE" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </label>
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtE" runat="server" placeholder="E Şıkkını Giriniz" class="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
                                                    Doğru Cevap :
													<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Text="*" ErrorMessage="Doğru Cevap Metnini Giriniz" ControlToValidate="txtDogruCevap" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </label>
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtDogruCevap" runat="server" placeholder="Doğru Cevap Metnini Giriniz" class="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
