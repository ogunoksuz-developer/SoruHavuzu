<%@ Page Title="" Language="C#" MasterPageFile="~/OgretmenPage.Master" AutoEventWireup="true" CodeBehind="OgretmenSinavaSoruEkle.aspx.cs" Inherits="SoruHavuzu.OgretmenSinavaSoruEkle" %>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Sınava Soru Atama
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="OgretmenSinavaSoruEkle.aspx">Sınava Soru Atama
                        </a>
                    </li>
                </ul>
                ...
                <div class="form-horizontal form-row-seperated">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>Sınava Soru Atama
                            </div>
                            <div class="actions btn-set">

                                <asp:Button ID="bnt_Save" runat="server" Text="Sınava Soruları Ata" class="btn green" OnClick="bnt_Save_Click" />
                        ...
                        <div class="portlet-body">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="OgretmenSinavaSoruEkle.aspx" data-toggle="tab">Sınava Soru Atama
                                        </a>
                                    </li>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:DropDownList ID="ddlDersAdi" runat="server" class="form-control" AppendDataBoundItems="true" OnDataBound="ddlDersAdi_DataBound" AutoPostBack="true" OnSelectedIndexChanged="ddlDersAdi_SelectedIndexChanged1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:DropDownList ID="ddlSinavAdi" runat="server" class="form-control" AppendDataBoundItems="true" OnDataBound="ddlSinavAdi_DataBound" AutoPostBack="true">
                                                        <asp:ListItem Text="Seçiniz" />
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
