...
{
    public partial class OgrenciSinavBaslangicEkrani : System.Web.UI.Page
    {
        ...
        protected void btnSinavBaslat_Click(object sender, EventArgs e)
        {
            Response.Redirect("OgrenciSinavEkrani.aspx");
        }
    }
}