<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="AdminOgrenciGuncelle.aspx.cs" Inherits="SoruHavuzu.AdminOgrenciGuncelle" %>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Öğrenci Güncelle
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="AdminOgrenciListesi.aspx">Öğrenci
                        </a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="AdminOgrenciGuncelle.aspx">Öğrenci Bilgileri Güncelle
                        </a>
                    </li>
                </ul>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButton ID="RadioButton1" GroupName="OgrDurumu" Text="Aktif" runat="server" />
                                                    <asp:RadioButton ID="RadioButton2" GroupName="OgrDurumu" Text="Pasif" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
