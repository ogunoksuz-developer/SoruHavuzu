<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="AdminOgretmenGuncelle.aspx.cs" Inherits="SoruHavuzu.AdminOgretmenGuncelle" %>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Öğretmen Güncelle
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    <li class="btn-group"></li>
                    <li>
                        <i class="fa fa-home"></i>
                        <a href="AdminFirstPage.aspx">SoruHavuzu
                        </a>
                    ...
                    <li>
                        <a href="AdminOgretmenGuncelle.aspx">Öğretmen Güncelle
                        </a>
                    </li>
                </ul>
                ...
                <div class="form-horizontal form-row-seperated">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>Öğretmen Bilgilerini Güncelle
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_general" data-toggle="tab">Öğretmen Bilgilerini Güncelle
                                        </a>
                                    </li>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButton ID="RadioButton1" GroupName="OgretDurumu" Text="Aktif" runat="server" />
                                                    <asp:RadioButton ID="RadioButton2" GroupName="OgretDurumu" Text="Pasif" runat="server" />
                                                </div>
                                            </div>
