<%@ Page Title="" Language="C#" MasterPageFile="~/UserPage.Master" AutoEventWireup="true" CodeBehind="OgrenciSinavOturumu.aspx.cs" Inherits="SoruHavuzu.OgrenciSinavOturumu" %>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="SinavOturumu.aspx">Sınav Oturumu
                        </a>
                    </li>
                </ul>
                ...
                <div class="form-horizontal form-row-seperated">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>Sınav Oturumu
                            </div>
                            <div class="actions btn-set">
                                
                                <asp:Button ID="btnKaydet" runat="server" Text="Sınavı Başlat" class="btn green" OnClick="btnKaydet_Click" />
                        ...
                        <div class="portlet-body">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_general" data-toggle="tab">Sınav Özellikleri
                                        </a>
                                    </li>
