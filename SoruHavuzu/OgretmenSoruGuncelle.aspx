<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="OgretmenSoruGuncelle.aspx.cs" Inherits="SoruHavuzu.OgretmenSoruGuncelle" %>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtSoruAdi" runat="server" placeholder="Soru Metnini Giriniz" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtDogruCevap" runat="server" placeholder="Doğru Cevabı Giriniz" class="form-control">
