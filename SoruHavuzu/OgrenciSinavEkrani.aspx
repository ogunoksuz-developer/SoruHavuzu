<%@ Page Title="" Language="C#" MasterPageFile="~/UserPage.Master" AutoEventWireup="true" CodeBehind="OgrenciSinavEkrani.aspx.cs" Inherits="SoruHavuzu.OgrenciSinavEkrani" %>
                    ...
                    <div class="portlet">
                        <div class="portlet-title">
                            ...
                            <div class="actions btn-set">
                                ...
                                <asp:Button ID="btnSinavBitir" runat="server" Text="Sınavı Bitir" class="btn green" OnClick="btnSinavBitir_Click" />
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:Timer ID="tmrKalanSure" Interval="1000" runat="server" OnTick="tmrKalanSure_Tick">
                                                </asp:Timer>
                                                <asp:UpdatePanel ID="UpdatePane1" UpdateMode="Conditional" runat="server">
                                                    <ContentTemplate>
                                                    ...
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="tmrKalanSure" EventName="Tick" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
                                                    Soru
                                                    <asp:Label ID="lblSoruNo" runat="server" Text="Label"></asp:Label>
                                                    :													
                                                </label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButton GroupName="rbSorular" ID="rbA" runat="server" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButton GroupName="rbSorular" ID="rbB" runat="server" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButton GroupName="rbSorular" ID="rbC" runat="server" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButton GroupName="rbSorular" ID="rbD" runat="server" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButton GroupName="rbSorular" ID="rbE" runat="server" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButton GroupName="rbSorular" ID="rbDogruCevap" runat="server" Visible="false" />
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <div class="col-md-10">
                                                    <asp:Button ID="Button2" runat="server" Text="Geri" OnClick="Button2_Click" class="btn green" />
                                                    <asp:Button ID="Button1" runat="server" Text="İleri" OnClick="Button1_Click" class="btn green" />
                                                </div>
                                                <div class="actions btn-set">
                                                    <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Destek" class="btn green" OnClick="LinkButton3_Click">Sorun Bildir</asp:LinkButton>
                                                </div>
                                            </div>
