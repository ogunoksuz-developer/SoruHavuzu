<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="AdminKonuGuncelle.aspx.cs" Inherits="SoruHavuzu.AdminKonuGuncelle" %>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="AdminKonuListesi.aspx">Konu
                        </a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="AdminKonuGuncelle.aspx">Konu Guncelle
                        </a>
                    </li>
                </ul>
                ...
                <div class="form-horizontal form-row-seperated">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>Konu Güncelle
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_general" data-toggle="tab">Konu Bilgilerini Güncelle
                                        </a>
                                    </li>
