<%@ Page Title="" Language="C#" MasterPageFile="~/UserPage.Master" AutoEventWireup="true" CodeBehind="OgrenciTalepEkle.aspx.cs" Inherits="SoruHavuzu.OgrenciTalepEkle" %>
     ...
     <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Yeni Talep
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="YeniTalepEkle.aspx">Yeni Talep
                        </a>
                    </li>
                </ul>
                ...
                <div class="form-horizontal form-row-seperated">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>Yeni Talep Oluştur
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_general" data-toggle="tab">Yeni Talep Oluştur
                                        </a>
                                    </li>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtTalepTuru" runat="server" placeholder="Talep Türünü Giriniz" class="form-control" >
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:TextBox ID="txtAciklama" runat="server" placeholder="Talep Açıklamasını Giriniz" class="form-control" TextMode="MultiLine">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
