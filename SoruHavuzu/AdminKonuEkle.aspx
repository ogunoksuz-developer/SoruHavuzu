<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="AdminKonuEkle.aspx.cs" Inherits="SoruHavuzu.AdminKonuEkle" %>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="AdmdinKonuListesi.aspx">Konu
                        </a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="YeniKonuEkle.aspx">Yeni Konu
                        </a>
                    </li>
                </ul>
                ...
                <div class="form-horizontal form-row-seperated">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>Yeni Konu Kaydı
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="AdminKonuEkle.aspx" data-toggle="tab">Yeni Konu Oluştur
                                        </a>
                                    </li>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:DropDownList ID="ddlDersAdi" runat="server" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">
													...
													<asp:RequiredFieldValidator ID="rfvKonu" runat="server" Text="*" ErrorMessage="Konu Adını Giriniz" ForeColor="Red" ControlToValidate="txtKonuAdi"></asp:RequiredFieldValidator>
                                                </label>
                                                <div class="col-md-10">

                                                    <asp:TextBox ID="txtKonuAdi" runat="server" placeholder="Konu Adini Giriniz" class="form-control">
